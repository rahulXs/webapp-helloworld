window.onload = function(){
    ...
    var random =document.getElementById('buttonRandom');
    var helloWorld = [
       ...
       setInterval(function () {
         var randomizer =
         Math.floor(Math.random() * helloWorld.length)
         div.innerHTML = helloWorld[randomizer];
         if (div.className== "container animateOff")
